...
// Disable the stop button until game start.
window.onload = function() {watch()};
function watch() {
	var btn = document.getElementById('btnStop');
	btnDisabled(btn);  // disable the stop
}

//Roll for placement function
